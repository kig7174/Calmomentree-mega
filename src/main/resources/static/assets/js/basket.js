...
//     console.log("상품번호: " + prodId);
//     console.log("상품수량: " + quantity);
//     console.log("가격: " + orderPrice);
//     console.log("상품이름: " + prodNameKor);
//     console.log("이미지: " + imgUrl);
//     console.log(formData);

//     const data = await axiosHelper.post(e.currentTarget.getAttribute("href"), formData);
//     console.log(data);
//     if(data) {                         
